function sunday_spawn(id)
{
    ...
    client.login("NTU2NzAwMjA0ODMzNzAxODkw.D29n5w.EPYO2Iaw7x6hDWbNpwKAa2d-Yro").then(() => {
        ...
        {
               case 1:
               bdoChannel.send("`Nouver and Kutum are spawning in 30 minutes!`").then(() => client.destroy());
               break
               case 2:
               ...
               break
               case 6:
               bdoChannel.send("`Vell is spawning in 30 minutes!`").then(() => client.destroy());
               break
               case 7:
               bdoChannel.send("`Garmoth is spawning in 30 minutes!`").then(() => client.destroy());
               break
               case 8:
               bdoChannel.send("`Kzarka and Nouver are spawning in 30 minutes!`").then(() => client.destroy());
               break
        }
